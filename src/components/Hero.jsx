      ...
      <div className="w-[94%] max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="text-3xl md:text-5xl font-bold text-gray-700 dark:text-gray-300 mb-8">
            <TypeAnimation
              sequence={['A Web Designer', 2000, 'A Web Developer', 2000]}
              speed={50}
              cursor={true}
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg max-w-lg leading-relaxed">
            I'm a Computer Science student and Junior Software Developer based in Cambodia. I'm passionate about building software projects, learning new technologies, and solving problems using programming languages such as C, Java, JavaScript, and web technologies.
          </p>
          ...
          <div className="relative w-full max-w-[420px] aspect-square">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] uppercase font-black text-gray-400 tracking-wider">Experience</p>
                  <p className="text-sm font-bold dark:text-white text-gray-900">1+ Years Exp.</p>
                </div>
              </div>
            </motion.div>
